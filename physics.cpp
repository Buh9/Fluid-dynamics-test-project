...
// TODO: make custom Smoothing Kernal for the best density function
...
vector <double> SphereByPlane(sphere &s1, vector <double> &P1, double dotx, double doty, double dotz) {
	S1 = s1.getPosition();	
	S1radius = s1.getRadius();
...
void physics::Step(double dt) {
	...
	// TODO: add to the particles themselves there own density simulation
